(ns mesomatic.examples.hello.framework
  ""
  (:require [clojure.core.async :as a :refer [chan <! go]]
            ...
            [mesomatic.examples.hello.executor :as example-executor]
            [mesomatic.examples.hello.offers :as offers]
...
(defn run
  ...
  (let [ch (chan)
        ...
        driver (scheduler-driver sched
                                 ...
                                 nil
                                 false)]
    (log/debug "Starting hello-world scheduler ...")
